...
<?php include "header.php" ?>
	<div class="container">
        ...
        <?php foreach ($items as $item){ ?>
			...
			<?php if($item["image"]!=''){ ?>
            	<a href="<?php echo WEB_URL; ?>/items/<?php echo $item["id"] ?>">
				<div class="explore-item-image" style="background: url('<?php echo WEB_URL; ?>/images/uploads/items/<?php $images = explode(",",$item["image"]); $img = explode(".", $images[0]); echo $img[0] . "_288_288." . $img[1]; ?>') no-repeat; background-size: 100%;">
			...
			<?php } ?>
                <div class="explore-item-info">
                	<div class="profile">
                    	...
                    	<img class="profile-pic" src="<?php echo WEB_URL; ?>/images/uploads/profile/<?php $pic = explode(".",$item["userimage"]); echo $pic[0] . "_38_38." . $pic[1]?>" alt="Profile Img" style="width:38px;">
                        </div>
                        <div class="profile-info">
                                 <span class="username"><?php echo $item["username"]?></span><br>
                                 <span class="location"><img src="<?php echo WEB_URL; ?>/templates/img/location.png" alt="Location" style="width:13px;"> <?php echo $item["locality"]?></span>
                         </div>
                         <div class="explore-title">
                         	<span class="title"><a href="<?php echo WEB_URL; ?>/items/<?php echo $item["id"] ?>"><?php echo $item["title"]?></a></span>
                         </div>
            ...
            <div class="explore-item">
                ...
                <div class="explore-item-info">
                	<div class="profile">
                    	<div class="profile-image product-info">
                    	<img class="profile-pic" src="<?php echo WEB_URL; ?>/templates/img/profile-pic-small.png" alt="Profile Img" style="width:38px;">
                        </div>
                        <div class="profile-info">
                                 <span class="username">ramikabar</span><br>
                                 <span class="location"><img src="<?php echo WEB_URL; ?>/templates/img/location.png" alt="Location" style="width:13px;"> Bossley Park</span>
                         </div>
                         <div class="explore-title">
