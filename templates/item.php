                            ...
                            <div class="product-info box item">
                              <div class="profile-image">
                               ...
                               <div class="profile-info">
                                 ...
                                 <span class="location"><img src="<?php echo WEB_URL; ?>/templates/img/location.png" alt="Location"> <?php echo $locality ?></span>
                               </div>
                                  ...
                                  <div class="row">
                                    <div class="col-xs-12 col-sm-6 device-button">
                                      <a href="https://play.google.com/store/apps/details?id=com.vp.jimbo&hl=en">
                                        <div class="centered">
                                          <img src="<?php echo WEB_URL; ?>/templates/img/download-android.png" alt="Download on Android" />
                                          <h4>Android</h4>
                                        </div>
                                      </a>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 device-button">
                                      <a href="#contact-popup2" class="popup-text" data-effect="mfp-zoom-out">  
                                        <div class="centered">
                                          <img src="<?php echo WEB_URL; ?>/templates/img/download-iphone.png" alt="Download on iPhone" />
                                          <h4>iPhone</h4>
                                        </div>
                                      </a>
                                    </div>
                                ...
                                <div id="contact-popup2" class="mfp-with-anim mfp-hide mfp-dialog">
                                  ...
                                  <div class="row">
                                    <div class="col-xs-12">
                                      <form name="contactForm" id="contact-form" class="contact-form" method="post" action="<?php echo WEB_URL; ?>items/<?php echo $item_id ?>/contact">
                        <fieldset>
                                    ...
                                    <li>
                                        ...
                                        <article class="comment">
                                            <div class="comment-author">
                                                <img src="<?php echo WEB_URL; ?>/images/uploads/profile/<?php echo $comment["userimage"] ?>" alt="Profile Image" />
                                            </div>
                    ...
                    <div class="gap gap-small"></div>    
                      ...
                      <?php foreach ($selleritems as $item){ ?>
                          <div class="col-xs-6 col-md-2">
                              <a href="<?php echo WEB_URL; ?>/items/<?php echo $item["id"] ?>"	><div class="product-thumb">
                                <?php if($item["image"]!=''){ ?>                                 
								 <header class="product-header">
                                      <img src="<?php echo WEB_URL; ?>/images/uploads/items/<?php $images = explode(",",$item["image"]); echo $images[0]; ?>" alt="Image Alternative text" title="Ana 29" />
                                  </header>
								<?php } ?>
