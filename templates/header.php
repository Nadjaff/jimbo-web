            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-5 ">
                      <a href="http://jimbo.co" class="logo"><img src="<?php echo WEB_URL; ?>/templates/img/logo.png" alt="Jimbo Logo" /></a>
                    </div>
                    <div class="col-xs-12 col-sm-7">
                      <div class="search-area-division search-area-division-input">
                          <input class="form-control" type="text" placeholder="Search..." />
                          <img src="<?php echo WEB_URL; ?>/templates/img/search.svg" alt="Search" class="search-icon" />
                      </div>
                    </div>
                </div>
            </div>
